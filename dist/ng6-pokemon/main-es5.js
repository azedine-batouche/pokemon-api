...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, authGuard, router) {
    ...
    AppComponent.prototype.gotoApi = function () {
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.displayNavbar = function () {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (name, password) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(true).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["delay"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (val) { _this.isLoggedIn = isLoggedIn; }));
    };
    AuthService.prototype.logout = function () {
        this.isLoggedIn = false;
    };
    AuthService.prototype.displayNav = function () {
...
var DetailPokemonApiComponent = /** @class */ (function () {
    function DetailPokemonApiComponent(pokeService, router, route) {
    ...
    DetailPokemonApiComponent.prototype.ngOnInit = function () {
        this.getDescription();
        this.detailPokemon();
    };
    DetailPokemonApiComponent.prototype.getDescription = function () {
        var _this = this;
        this.idPokemon = +this.route.snapshot.paramMap.get('id');
        this.pokeService.getdescription(this.idPokemon).pipe().subscribe(function (res) {
            res['flavor_text_entries'].forEach(function (element, index) {
                if (element['language']['name'] === 'fr' && element['flavor_text'] !== '') {
                    return _this.description.push(element['flavor_text']);
                }
            });
        });
    };
    DetailPokemonApiComponent.prototype.detailPokemon = function () {
        var _this = this;
        this.idPokemon = +this.route.snapshot.paramMap.get('id');
        this.pokeService.getdetailPoke(this.idPokemon).subscribe(function (res) {
            _this.name = res['name'],
                _this.weight = res['weight'],
                _this.height = res['height'],
                _this.baseExp = res['base_experience'],
                res['types'].forEach(function (element) { _this.types.push(element['type']['name']); }),
                res['stats'].forEach(function (stats) { _this.baseStat.push(stats['base_stat']); }),
                res['abilities'].forEach(function (abilities) { _this.abilities.push(abilities['ability']['name']); }),
                res['moves'].forEach(function (moves) { _this.moves.push(moves['move']['name']); });
        });
    };
    DetailPokemonApiComponent.prototype.gobackToList = function () {
        this.router.navigate(['/pokemons/pokeapi']);
    };
    DetailPokemonApiComponent.ctorParameters = function () { return [
    ...
    return DetailPokemonApiComponent;
}());
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        var pokemons = _pokemons_mock_pokemons__WEBPACK_IMPORTED_MODULE_0__["POKEMON"];
...
var ListPokeApiComponent = /** @class */ (function () {
    function ListPokeApiComponent(pokeApiService, router) {
    ...
    ListPokeApiComponent.prototype.ngOnInit = function () {
        this.getPokeApi(this.nbPok, this.nbPokPage);
    };
    ListPokeApiComponent.prototype.ngAfterViewInit = function () {
    };
    ListPokeApiComponent.prototype.pokemon = function (nbPokemon, nbPage) {
        this.pokeApiService.getlistPokemon(nbPokemon, nbPage).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res['results']; })).subscribe(function (res) { console.log(res); }, function (err) { return console.log(err); });
    };
    ListPokeApiComponent.prototype.getPokeApi = function (nbPokemon, nbPage) {
        var _this = this;
        return this.pokeApiService.getPokemons(nbPokemon, nbPage).then(function (res) { _this.listPokemons = res, _this.success = true; }, function (err) { _this.success = false; });
    };
    ListPokeApiComponent.prototype.getMorePokemon = function () {
        this.nbPok += this.nbMorePok;
        this.nbPokPage += this.nbMorePok;
        this.getPokeApi(this.nbPok, this.nbMorePok);
    };
    ListPokeApiComponent.prototype.detailPokemon = function (idPokemon) {
        this.router.navigate(['/pokemons/pokeapi', idPokemon]);
    };
    ListPokeApiComponent.prototype.search = function (key) {
        var _this = this;
        this.loading = true;
        key = key.trim();
        if (key && key !== '') {
            key = key.toLowerCase();
            this.pokeApiService.getPokemonSearchFromApi(key).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])()).subscribe(function (results) {
                _this.searchPokemon.name = results['name'],
                    _this.searchPokemon.id = results['id'],
                    _this.searchPokemon.urlImage = 'https://pokeres.bastionbot.org/images/pokemon/' + results['id'] + '.png',
                    _this.searchAccess = true;
    ...
    ListPokeApiComponent.prototype.goToList = function () {
        this.searchAccess = false;
        this.router.navigate(['/pokemons/pokeapi']);
        this.input.nativeElement.value = '';
    };
    ListPokeApiComponent.ctorParameters = function () { return [
...
var PokeapiService = /** @class */ (function () {
    ...
    PokeapiService.prototype.getlistPokemon = function (nbPokemon, pageNumber) {
        return this.http.get(this.POKE_API_URL + '?limit=' + nbPokemon + '&offset=' + pageNumber);
    };
    PokeapiService.prototype.getdetailPokemon = function (pokemon) {
        return this.http.get(pokemon);
    };
    PokeapiService.prototype.getdetailPoke = function (idPokemon) {
        return this.http.get(this.POKE_API_URL + idPokemon);
    };
    PokeapiService.prototype.getPokemons = function (nbPokemon, nbPage) {
        var _this = this;
        return this.http.get(this.POKE_API_URL + '?limit=' + nbPokemon + '&offset:' + nbPage)
            ...
            return {
                ...
                name: item.name,
                url: item.url,
                urlImage: _this.IMAGE_API_URL + item.url.split(/\//)[6] + '.png'
            };
        }); });
    };
    ;
    PokeapiService.prototype.getPokemonSearchFromApi = function (key) {
        return this.http.get(this.POKE_API_URL + key);
    };
    PokeapiService.prototype.getdescription = function (idPokemon) {
...
var BorderCardDirective = /** @class */ (function () {
    ...
    BorderCardDirective.ctorParameters = function () { return [
...
var DetailPokemonComponent = /** @class */ (function () {
    ...
    DetailPokemonComponent.prototype.deletePokemon = function (pokemon) {
        var _this = this;
        this.pokemonsService.deletePokemon(pokemon).subscribe(function () { return _this.goBack(); });
    };
    ...
    DetailPokemonComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var EditPokemonComponent = /** @class */ (function () {
    ...
    EditPokemonComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _pokemons_service__WEBPACK_IMPORTED_MODULE_3__["PokemonsService"] }
    ]; };
...
var ListPokemonComponent = /** @class */ (function () {
    ...
    ListPokemonComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _pokemons_service__WEBPACK_IMPORTED_MODULE_3__["PokemonsService"] }
    ]; };
...
var PokemonsFormComponent = /** @class */ (function () {
    function PokemonsFormComponent(pokemonsService, router) {
        this.pokemonsService = pokemonsService;
        this.router = router;
    }
    PokemonsFormComponent.prototype.ngOnInit = function () {
    ...
    PokemonsFormComponent.prototype.hasType = function (type) {
        var index = this.pokemon.types.indexOf(type);
        if (~index)
            return true;
        return false;
    };
    PokemonsFormComponent.prototype.isTypesValid = function (type) {
    ...
    PokemonsFormComponent.prototype.selectType = function ($event, type) {
    ...
    PokemonsFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.pokemonsService.updatePokemon(this.pokemon)
            .subscribe(function () { return _this.goBack(); });
    };
    PokemonsFormComponent.prototype.goBack = function () {
        var link = ['/pokemons', this.pokemon.id];
        this.router.navigate(link);
    };
    PokemonsFormComponent.ctorParameters = function () { return [
...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.getPokemons = function () {
        // return POKEMON;
        return this.http.get(this.pokemonsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("fetched pokemons"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getPokemons", [])));
    };
    ...
    PokemonsService.prototype.getPokemon = function (id) {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("fetched pokemon id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("get pokemon id=" + id)));
    };
    PokemonsService.prototype.updatePokemon = function (pokemon) {
        var httpOption = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
        return this.http.put(this.pokemonsUrl, pokemon, httpOption).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("updated pokemon id=" + pokemon.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('UpdatedPokemon')));
    };
    PokemonsService.prototype.searchPokemon = function (term) {
        if (!term.trim()) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([]);
        }
        return this.http.get(this.pokemonsUrl + "?name=" + term).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("Found pokemon matching \"" + term + "\" "); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('SearchPokemon', [])));
    };
    PokemonsService.prototype.deletePokemon = function (pokemon) {
        ...
        return this.http.delete(url, httpOption).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return console.log("deleted pokemon id=" + pokemon.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deletedPokemon')));
    };
    // Retourne tous les types d'un pokemon
    PokemonsService.prototype.getPokemonType = function () {
        return ['Feu', 'Eau', 'Plante', 'Inscete', 'Normal', 'Electrik', 'Poisson', 'Fée', 'Vol'];
    };
    PokemonsService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var PokemonSearchComponent = /** @class */ (function () {
    ...
    PokemonSearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pokemons$ = this.searchTerms.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (term) { return _this.pokemonsService.searchPokemon(term); }));
    };
    PokemonSearchComponent.prototype.gotoDetail = function (pokemon) {
        var link = ['/pokemons', pokemon.id];
        this.router.navigate(link);
    };
    PokemonSearchComponent.ctorParameters = function () { return [
